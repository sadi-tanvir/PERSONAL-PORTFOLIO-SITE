...
const SadiE_ShopProject = () => {
    ...
    return (
        <div className="container rounded-md bg-gray-800 shadow-2xl my-16 pb-5">
            <div className="container grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div className="grid grid-cols-4 gap-2 items-center px-3">
                        ...
                        {sliderImages.map((slide, inx) => (
                            <Image onClick={() => setCurrentSlider(inx)} key={inx}
                                src={slide} className={`h-10 w-auto ${currentSlider === inx ? 'border-2 border-black p-px' : ''} rounded-md md:rounded-lg box-content cursor-pointer`}
                                alt={"image"} />
                        ))}
                    </div>
                </div>
                ...
                <div className="flex-col text-gray-300 md:col-span-2">
                    <p className="pt-4 text-2xl font-bold ml-5 md:ml-0 text-center sm:text-start">E-Shop</p>
                    ...
                    <div className="text-xs mt-10 flex flex-wrap justify-center md:justify-start">
                        <ExternalLinkBtn link="https://sadi-e-shop.vercel.app">
                            Live Website
                        </ExternalLinkBtn>

                        <ExternalLinkBtn link="https://github.com/sadi-tanvir/Sadi-EShop">
                            Github Code
                        </ExternalLinkBtn>

                        <ExternalLinkBtn link="https://github.com/sadi-tanvir/Sadi-EShop#sadi-eshop">
                            Project Details
                        </ExternalLinkBtn>
                    </div>
                </div>
...
export default SadiE_ShopProject;