...
const ContactMe = () => {
    return (
        <section id='contact' className="container mx-auto rounded-lg px-5 bg-gray-800 text-white py-16 relative overflow-hidden my-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gray-200 p-8 rounded-md shadow-lg">
                        <form>
                            ...
                            <button type="submit" className="bg-gray-800 text-white p-3 rounded-md hover:bg-gray-800 transition duration-300">Send Message</button>
                        </form>
                    </div>
                </div>
            </div>

            {/* Extraordinary Background Animation */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <div className="absolute animate-bubbles" />
            </div>
        </section>
    );
};
